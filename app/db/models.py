...
class PostJob(Base):
    ...
    genre_key: Mapped[str | None] = mapped_column(String(255), nullable=True)
    genre_label: Mapped[str | None] = mapped_column(String(255), nullable=True)
    caption_instruction: Mapped[str | None] = mapped_column(Text, nullable=True)
